      ...
      child: Text.rich(
        TextSpan(
          children: [
            TextSpan(
              text:
                  'Sering terbangun malam hari bisa menjadi masalah serius bagi kesehatan seseorang karena dapat mengganggu pola ',
              style: TextStyle(
                color: Colors.black,
                fontSize: 12,
                fontFamily: 'Montserrat',
            ...
            TextSpan(
              text:
                  'yang sehat. Gangguan ini juga dapat mengakibatkan kualitas tidur yang buruk, kelelahan, dan bahkan gangguan kesehatan lainnya. Oleh karena itu, penting bagi kita untuk memahami penyebab terbangun malam serta cara mengatasinya.\n\nBeberapa penyebab umum ',
              style: TextStyle(
                color: Colors.black,
                fontSize: 12,
                fontFamily: 'Montserrat',
            ...
            TextSpan(
              text:
                  ' malam hari termasuk stres, kegelisahan, konsumsi alkohol atau kafein sebelum tidur. Selain itu, faktor lingkungan seperti suhu kamar tidur yang terlalu panas atau terlalu dingin juga dapat menjadi penyebab seseorang terbangun malam.\n\n',
              style: TextStyle(
                color: Colors.black,
                fontSize: 12,
                fontFamily: 'Montserrat',
